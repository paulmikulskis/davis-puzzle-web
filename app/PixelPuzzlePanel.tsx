...
// Pixel Puzzle panel — the existing 4-page Letter pixel-art worksheet
// generator, lifted out of app/page.tsx so / can host a tab strip with
// both Pixel Puzzle and Maze Hunt. Behavior is byte-identical to the
// pre-tab-strip / including the Confirm-download lifecycle and the catalog
// browser.
...
export function PixelPuzzlePanel() {
